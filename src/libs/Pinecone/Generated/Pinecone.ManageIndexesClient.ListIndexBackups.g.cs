...
namespace Pinecone
{
    public partial class ManageIndexesClient
    {
        ...
        private static readonly global::Pinecone.EndPointSecurityRequirement s_ListIndexBackupsSecurityRequirement0 =
        ...
        private static readonly global::Pinecone.EndPointSecurityRequirement[] s_ListIndexBackupsSecurityRequirements =
            new global::Pinecone.EndPointSecurityRequirement[]
            {                s_ListIndexBackupsSecurityRequirement0,
            };
        partial void PrepareListIndexBackupsArguments(
        ...
        partial void ProcessListIndexBackupsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListIndexBackupsArguments(
            ...
            var __authorizations = global::Pinecone.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListIndexBackupsSecurityRequirements,
                operationName: "ListIndexBackupsAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Pinecone.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Pinecone.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListIndexBackups",
                                methodName: "ListIndexBackupsAsync",
                                pathTemplate: "$\"/indexes/{indexName}/backups\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListIndexBackupsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Pinecone.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListIndexBackupsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
