...
namespace Pinecone
{
    public partial interface IManageIndexesClient
    {
        ...
        global::System.Threading.Tasks.Task DeleteBackupScheduleAsync(
            string scheduleId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Pinecone.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Pinecone.AutoSDKHttpResponse> DeleteBackupScheduleAsResponseAsync(
            string scheduleId,
            string xPineconeApiVersion = "2026-04",
            global::Pinecone.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
