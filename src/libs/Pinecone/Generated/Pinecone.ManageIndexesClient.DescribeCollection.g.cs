...
namespace Pinecone
{
    public partial class ManageIndexesClient
    {
        ...
        partial void PrepareDescribeCollectionRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string xPineconeApiVersion,
            string collectionName);
        partial void ProcessDescribeCollectionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDescribeCollectionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Pinecone.CollectionModel> DescribeCollectionAsync(
            string collectionName,
            string xPineconeApiVersion = "2026-04",
            global::Pinecone.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await DescribeCollectionAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Pinecone.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Pinecone.AutoSDKHttpResponse<global::Pinecone.CollectionModel>> DescribeCollectionAsResponseAsync(
            string collectionName,
            string xPineconeApiVersion = "2026-04",
            global::Pinecone.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDescribeCollectionArguments(
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDescribeCollectionRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Pinecone.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Pinecone.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "DescribeCollectionAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDescribeCollectionResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Pinecone.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDescribeCollectionResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Pinecone.CollectionModel.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Pinecone.AutoSDKHttpResponse<global::Pinecone.CollectionModel>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Pinecone.CollectionModel.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
