...
namespace Pinecone
{
    public partial class ManageIndexesClient
    {
        ...
        private static readonly global::Pinecone.EndPointSecurityRequirement s_DescribeBackupSecurityRequirement0 =
        ...
        private static readonly global::Pinecone.EndPointSecurityRequirement[] s_DescribeBackupSecurityRequirements =
            new global::Pinecone.EndPointSecurityRequirement[]
            {                s_DescribeBackupSecurityRequirement0,
            };
        partial void PrepareDescribeBackupArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string xPineconeApiVersion,
            ref string backupId);
        partial void PrepareDescribeBackupRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string xPineconeApiVersion,
            string backupId);
        partial void ProcessDescribeBackupResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDescribeBackupResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Pinecone.BackupModel> DescribeBackupAsync(
            string backupId,
            string xPineconeApiVersion = "2026-04",
            global::Pinecone.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await DescribeBackupAsResponseAsync(
                backupId: backupId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Pinecone.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Pinecone.AutoSDKHttpResponse<global::Pinecone.BackupModel>> DescribeBackupAsResponseAsync(
            string backupId,
            string xPineconeApiVersion = "2026-04",
            global::Pinecone.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDescribeBackupArguments(
            ...
            var __authorizations = global::Pinecone.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DescribeBackupSecurityRequirements,
                operationName: "DescribeBackupAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Pinecone.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Pinecone.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "DescribeBackupAsync",
                                pathTemplate: "$\"/backups/{backupId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Pinecone.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDescribeBackupResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Pinecone.BackupModel.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Pinecone.AutoSDKHttpResponse<global::Pinecone.BackupModel>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Pinecone.BackupModel.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
