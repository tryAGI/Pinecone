...
namespace Pinecone
{
    public partial class ManageIndexesClient
    {
        ...
        private static readonly global::Pinecone.EndPointSecurityRequirement s_ListRestoreJobsSecurityRequirement0 =
        ...
        private static readonly global::Pinecone.EndPointSecurityRequirement[] s_ListRestoreJobsSecurityRequirements =
            new global::Pinecone.EndPointSecurityRequirement[]
            {                s_ListRestoreJobsSecurityRequirement0,
            };
        partial void PrepareListRestoreJobsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string xPineconeApiVersion,
            ref int? limit,
            ref string? paginationToken);
        partial void PrepareListRestoreJobsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string xPineconeApiVersion,
            int? limit,
            string? paginationToken);
        partial void ProcessListRestoreJobsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListRestoreJobsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Pinecone.RestoreJobList> ListRestoreJobsAsync(
        ...
        {
            var __response = await ListRestoreJobsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Pinecone.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Pinecone.AutoSDKHttpResponse<global::Pinecone.RestoreJobList>> ListRestoreJobsAsResponseAsync(
            string xPineconeApiVersion = "2026-04",
            int? limit = default,
            string? paginationToken = default,
            global::Pinecone.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListRestoreJobsArguments(
            ...
            var __authorizations = global::Pinecone.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListRestoreJobsSecurityRequirements,
                operationName: "ListRestoreJobsAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Pinecone.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Pinecone.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ListRestoreJobsAsync",
                                pathTemplate: "\"/restore-jobs\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListRestoreJobsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Pinecone.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListRestoreJobsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Pinecone.RestoreJobList.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Pinecone.AutoSDKHttpResponse<global::Pinecone.RestoreJobList>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Pinecone.RestoreJobList.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
