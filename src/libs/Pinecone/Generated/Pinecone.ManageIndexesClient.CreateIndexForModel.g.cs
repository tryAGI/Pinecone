...
namespace Pinecone
{
    public partial class ManageIndexesClient
    {
        ...
        private static readonly global::Pinecone.EndPointSecurityRequirement s_CreateIndexForModelSecurityRequirement0 =
        ...
        private static readonly global::Pinecone.EndPointSecurityRequirement[] s_CreateIndexForModelSecurityRequirements =
            new global::Pinecone.EndPointSecurityRequirement[]
            {                s_CreateIndexForModelSecurityRequirement0,
            };
        partial void PrepareCreateIndexForModelArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string xPineconeApiVersion,
            global::Pinecone.CreateIndexForModelRequest request);
        partial void PrepareCreateIndexForModelRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string xPineconeApiVersion,
            global::Pinecone.CreateIndexForModelRequest request);
        partial void ProcessCreateIndexForModelResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateIndexForModelResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Pinecone.IndexModel> CreateIndexForModelAsync(
        ...
        {
            var __response = await CreateIndexForModelAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Pinecone.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Pinecone.AutoSDKHttpResponse<global::Pinecone.IndexModel>> CreateIndexForModelAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateIndexForModelArguments(
            ...
            var __authorizations = global::Pinecone.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateIndexForModelSecurityRequirements,
                operationName: "CreateIndexForModelAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateIndexForModelRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Pinecone.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Pinecone.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateIndexForModel",
                                methodName: "CreateIndexForModelAsync",
                                pathTemplate: "\"/indexes/create-for-model\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateIndexForModelResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Pinecone.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateIndexForModelResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Pinecone.IndexModel.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Pinecone.AutoSDKHttpResponse<global::Pinecone.IndexModel>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Pinecone.IndexModel.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await CreateIndexForModelAsync(
                xPineconeApiVersion: xPineconeApiVersion,
                request: __request,
                requestOptions: requestOptions,
