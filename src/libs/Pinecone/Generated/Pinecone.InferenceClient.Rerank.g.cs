...
namespace Pinecone
{
    public partial class InferenceClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Pinecone.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Pinecone.AutoSDKHttpResponse<global::Pinecone.RerankResult>> RerankAsResponseAsync(
                    ...
                    await global::Pinecone.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Pinecone.RerankResult.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Pinecone.AutoSDKHttpResponse<global::Pinecone.RerankResult>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Pinecone.RerankResult.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
