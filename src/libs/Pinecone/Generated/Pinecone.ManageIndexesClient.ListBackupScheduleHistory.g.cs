...
namespace Pinecone
{
    public partial class ManageIndexesClient
    {
        ...
        private static readonly global::Pinecone.EndPointSecurityRequirement s_ListBackupScheduleHistorySecurityRequirement0 =
        ...
        private static readonly global::Pinecone.EndPointSecurityRequirement[] s_ListBackupScheduleHistorySecurityRequirements =
            new global::Pinecone.EndPointSecurityRequirement[]
            {                s_ListBackupScheduleHistorySecurityRequirement0,
            };
        partial void PrepareListBackupScheduleHistoryArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string xPineconeApiVersion,
            ref string scheduleId,
            ref int? limit,
            ref string? paginationToken);
        partial void PrepareListBackupScheduleHistoryRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessListBackupScheduleHistoryResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListBackupScheduleHistoryResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Pinecone.BackupScheduleHistoryList> ListBackupScheduleHistoryAsync(
            string scheduleId,
        ...
        {
            var __response = await ListBackupScheduleHistoryAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Pinecone.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Pinecone.AutoSDKHttpResponse<global::Pinecone.BackupScheduleHistoryList>> ListBackupScheduleHistoryAsResponseAsync(
            string scheduleId,
            string xPineconeApiVersion = "2026-04",
            int? limit = default,
            string? paginationToken = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListBackupScheduleHistoryArguments(
            ...
            var __authorizations = global::Pinecone.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListBackupScheduleHistorySecurityRequirements,
                operationName: "ListBackupScheduleHistoryAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Pinecone.PathBuilder(
                                path: $"/backup-schedules/{scheduleId}/history",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListBackupScheduleHistoryRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Pinecone.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Pinecone.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListBackupScheduleHistory",
                                methodName: "ListBackupScheduleHistoryAsync",
                                pathTemplate: "$\"/backup-schedules/{scheduleId}/history\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                cancellationToken: __effectiveCancellationToken).ConfigureAwait(false);
                    ...
                    {
                        var __retryDelay = global::Pinecone.AutoSDKRequestOptionsSupport.GetRetryDelay(
                            clientOptions: Options,
                            requestOptions: requestOptions,
                            response: null,
                            attempt: __attempt);
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListBackupScheduleHistoryResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Pinecone.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListBackupScheduleHistoryResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Pinecone.BackupScheduleHistoryList.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Pinecone.AutoSDKHttpResponse<global::Pinecone.BackupScheduleHistoryList>(
                                        statusCode: __response.StatusCode,
                                ...
                                {
                                    throw global::Pinecone.ApiException.Create(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Pinecone.BackupScheduleHistoryList.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
